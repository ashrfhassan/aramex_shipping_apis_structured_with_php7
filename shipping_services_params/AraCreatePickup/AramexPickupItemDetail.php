...
class AramexPickupItemDetail
{
    ...
    public function __construct($ProductGroup, $ProductType, $NumberOfShipments, $PackageType, $Payment, AramexWeight $ShipmentWeight, AramexVolume $ShipmentVolume, $NumberOfPieces, AramexMoney $CashAmount, AramexMoney $ExtraCharges, AramexDimensions $ShipmentDimensions, $Comments)
    {
